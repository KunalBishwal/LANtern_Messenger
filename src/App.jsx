...
function App() {
  ...
  const [messages, setMessages] = useState(() => {
    const saved = localStorage.getItem("lantern-messages")
  ...
  const [darkMode, setDarkMode] = useState(() => {
    const stored = localStorage.getItem("lantern-dark-mode")
  ...
  useEffect(() => {
    localStorage.setItem("lantern-dark-mode", JSON.stringify(darkMode))
    if (darkMode) {
